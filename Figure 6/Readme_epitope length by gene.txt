...
# Project Description
To map scored BKV epitopes onto different JCV antigens
...
JCV epitope lengths.xlsx: File containing epitope sequences.
JCV protein lengths.xlsx: File containing protein sequences.
...
1. Reads epitope sequences from 'JCV epitope lengths.xlsx' and protein sequences from 'JCV protein lengths.xlsx'.
